...
<script data-relocate="true">
	$(function() {
		new WCF.Action.Delete('wcf\\data\\package\\update\\server\\ToggleablePackageUpdateServerAction', '.jsUpdateServerRow');
		new WCF.Action.Toggle('wcf\\data\\package\\update\\server\\ToggleablePackageUpdateServerAction', '.jsUpdateServerRow');
	});
</script>
